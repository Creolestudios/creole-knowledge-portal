...
export default function LoginPage() {
  ...
  const getAuthRedirectOrigin = () => {
    ...
    if (window.location.hostname.includes('.elb.amazonaws.com')) {
      return 'https://dxad42dnfuckt.cloudfront.net/creole-knowledge-portal';
    }

    return `${window.location.origin}/creole-knowledge-portal`;
  };
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-zinc-200 rounded-lg hover:bg-zinc-50 transition-colors shadow-sm text-zinc-700 font-semibold text-sm active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {oauthLoading === 'google' ? (
