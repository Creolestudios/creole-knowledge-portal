...
import { User, Newspaper, History, BarChart3, Menu, X, Flame } from 'lucide-react';
...
type TabKey = 'daily' | 'past' | 'activity';
...
/**
 * Full user-dashboard layout: a dark sidebar holding the brand, the three
 ...
 * slide-in drawer. Shared by the real dashboard and the `/preview` page.
 */
