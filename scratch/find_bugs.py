"""List unresolved new-code Sonar issues. Requires SONAR_HOST_URL + SONAR_TOKEN."""
...
url = (
    ...
    "&inNewCodePeriod=true&resolved=false&ps=500"
)
...
for idx, issue in enumerate(issues[:25], 1):
