    ...
    <div className="min-h-screen bg-[#f8f9fa] flex">
      ...
      <aside className="w-72 bg-[#0a0a0a] text-white flex flex-col p-8 hidden md:flex border-r border-zinc-800 relative overflow-hidden">
        ...
        <nav className="flex-1 space-y-1 relative z-10">
          <button className="w-full flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all group bg-zinc-900/50 text-brand border border-brand/20 shadow-sm">
            <Home size={20} />
          ...
          <div className="max-w-6xl mx-auto">
            <div className="mb-12">
              ...
              <h1
                ...
                className="text-4xl font-black text-zinc-900 tracking-tight mb-3"
              >
                Your Morning Briefing
              </h1>
              <p className="text-zinc-500 text-lg">
                Welcome back! Here&apos;s what&apos;s trending in your knowledge network today.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="bg-white border border-zinc-100 rounded-[32px] p-8 shadow-card hover:shadow-[0_20px_50px_rgba(0,0,0,0.08)] transition-all group cursor-pointer border-b-4 border-b-transparent hover:border-b-brand"
                >
                  ...
                  <h3 className="text-2xl font-extrabold text-zinc-900 mb-3 group-hover:text-brand transition-colors">
                    Recommendation {i}
                  </h3>
                  <p className="text-zinc-500 mb-8 leading-relaxed text-sm">
                    High-impact industry research and internal blog highlights analyzed for your
